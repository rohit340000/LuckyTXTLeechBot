...
bot = Client("bot",
             bot_token=os.environ.get("7125899687:AAF8ZHqtziwW20yENI0J8kfxIcfatybfsf0"),
             api_id=int(os.environ.get("27498866")),
             api_hash=os.environ.get("96fbb6ad2e11ab04e83ca09ef3f42455"))
auth_users = [6488911325,6806097030]
sudo_users = [6488911325,6806097030]
sudo_groups = [-1002059340064]
